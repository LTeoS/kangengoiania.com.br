...
const Explanations = () => {
  ...
  return (
    <div className="flex flex-col gap-[60px] md:gap-[80px]">
      <div className="flex w-full flex-col items-center gap-[16px] text-center md:gap-[48px] lg:flex-row lg:gap-[56px]">
        <img
        ...
        />
        <div className="flex flex-col gap-[16px] md:text-left">
          <h1 className="text-[20px] md:text-[30px]">Rica em Hidrogênio</h1>
          <p className="max-w-[310px] text-[12px] md:max-w-[500px] md:text-[14.61px] lg:max-w-[560px]">{`A água que é rica em hidrogênio possui uma alta concentração de hidrogênio molecular (H2). O hidrogênio molecular atua como um antioxidante eficiente que se difunde rapidamente através das membranas celulares e pode reduzir os radicais livres, suprimindo o estresse oxidativo. Através do processo de eletrólise, a sua água da torneira se torna Kangen Water® rica em hidrogênio.`}</p>
        </div>
      </div>
      <div className="flex w-full flex-col items-center gap-[16px] text-center lg:flex-row lg:gap-[56px]">
        <img
          width={mobile ? 320 : 600}
          src={antioxidant}
          alt="Kangen-Goiania-Topic"
